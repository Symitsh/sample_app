...
class FollowTest < Following
  ...
  test "devrait follow un utilisateur de la manière standard" do
  ...
  test "devrait follow un utilisateur avec Hotwire" do
    assert_difference "@user.following.count", 1 do
...
class UnfollowTest < Unfollow
  ...
  test "devrait unfollow un utilisateur de la manière 'standard way'" do
    assert_difference "@user.following.count", -1 do
  ...
  test "devrait unfollow un utilisateur avec Hotwire" do
    assert_difference "@user.following.count", -1 do
